  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center justify-between mb-6">
        <Link href="/admin/cms/posts" className="flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700">
          <ArrowLeft size={16} /> Posts
        </Link>
        <button onClick={del} className="text-red-500 hover:text-red-700 flex items-center gap-1 text-sm">
